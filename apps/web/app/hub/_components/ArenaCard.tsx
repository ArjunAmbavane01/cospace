...
export default function ArenaCard({ }: ArenaCardProps) {
    return (
        <div className="flex flex-col gap-3 bg-card w-72 h-64 p-2 rounded-lg border relative overflow-hidden group">
