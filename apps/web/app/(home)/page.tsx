...
export default async function page() {
    ...
    return (
        <>
            <nav className='flex justify-between absolute top-8 inset-x-0 w-full max-w-3xl mx-auto p-3 px-5 rounded-lg bg-white/10 backdrop-blur-md border z-50'>
            ...
            <main className="flex h-screen w-full overflow-hidden relative">
                ...
                <div className="flex flex-col items-center justify-start gap-8 h-screen w-full pt-40 max-w-7xl mx-auto relative">
                    <div className="flex flex-col gap-2 text-center animate-fade-in-delay max-w-4xl">
                        <h1 className="text-5xl text-foreground font-light leading-relaxed text-balance z-10">
                    ...
                    <Link href="/hub" className={buttonVariants({ size: 'lg', className: "bg-white z-10 text-base! hover:bg-white/90 border" })}>
                        Try Demo
                    </Link>
                    ...
                    <div className="absolute top-[60%] inset-x-0 animate-slide-up w-4xl mx-auto z-10">
                        <div className="relative rounded-t-2xl overflow-hidden shadow-2xl shadow-white/20 border-t-4 border-x-4 border-white/30">
                            {/* Mockup browser bar */}
                            <div className="bg-background backdrop-blur-sm px-4 py-3 flex items-center gap-2 border-b border-gray-700/50">
                                <div className="flex gap-2">
                                    <div className="w-3 h-3 rounded-full bg-red-500"></div>
                                    <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
                                    <div className="w-3 h-3 rounded-full bg-green-500"></div>
                                </div>
                                <div className="flex-1 ml-4 bg-input rounded px-3 py-1 text-xs text-muted-foreground">
